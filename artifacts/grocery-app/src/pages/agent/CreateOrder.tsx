    ...
    <div className="space-y-5">
      ...
      {(partners as any[]).length === 0 && (
        <div className="p-4 rounded-lg border border-yellow-200 bg-yellow-50 text-sm text-yellow-800">
          No delivery partners registered yet. Ask an admin to add one in <strong>Delivery Partners</strong> first.
        </div>
      )}
    ...
    <AgentLayout>
      <div className="w-full space-y-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Choose the order type that matches the resident's situation.</p>
        </div>

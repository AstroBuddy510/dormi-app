...
import {
  Search, Send, MessageCircle, ChevronLeft, Phone, Users, Smile,
} from 'lucide-react';
...
function EmojiPicker({ onSelect, onClose }: { onSelect: (e: string) => void; onClose: () => void }) {
  ...
  return (
    <div
      ref={ref}
      className="absolute bottom-full mb-2 left-0 bg-white rounded-2xl shadow-xl border border-border p-3 w-72 z-50"
    >
        ...
        <div className="flex gap-2 items-end">
          <div className="flex-1 relative">
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-input bg-background px-3 py-2.5 pr-10 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 leading-relaxed"
